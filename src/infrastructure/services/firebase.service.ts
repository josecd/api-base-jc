...
import { UserI } from 'src/domains/interface/user.interface';
import { generateSecurePassword } from 'src/applications/utils/user.utils';
...
export class FirebaseService {
     ...
     */
    async authCreateUser(user: UserI): Promise<admin.auth.UserRecord> {
        try {
     ...
     */
    async authUpdateUser(user: UserI): Promise<admin.auth.UserRecord> {
        try {
